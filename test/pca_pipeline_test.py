...
def test_pca_pipeline(audio_features_df):
    ...
    pca_pipeline = ReductionPipeline(audio_features_df,
    ...
    embeddings = pca_pipeline.embeddings
    assert embeddings.shape == (1818, 2)
    embeddings_df = pca_pipeline.embeddings_df
    ...
    feature_importances = pca_pipeline.feature_importances
